        ...
        <div class="md:w-8/12 lg:w-8/12 w-full flex flex-col items-center md:flex-row">
            <div class="grid sm:grid-cols-1 grid-cols-3 w-full md:w-4/12 lg:w-4/12 items-center">
                ...
                <div class="pl-2 pr-6 text-start jus sm:hidden block col-span-2">
                    ...
                    @auth
                        @if ($user->id === auth()->user()->id)
                            <a href="{{route('edit')}}" class="mt-5 block w-full text-gray-800 text-sm hover:bg-gray-300 bg-gray-200 py-2 px-4 rounded-lg font-semibold cursor-pointer">
                                Editar perfil
                            </a>
                        @else
                ...
                <div class="p-1">
                    <div class="grid grid-cols-2 gap-4 items-center py-3">
                        ...
                        <div class="px-2 text-center sm:text-start hidden sm:block">
                            @auth
                                @if ($user->id === auth()->user()->id)
                                    <a href="{{ route('edit') }}" class="text-gray-800 text-sm hover:bg-gray-300 bg-gray-200 py-2 px-4 rounded-lg font-semibold cursor-pointer">
                                        Editar perfil
                                    </a>
                                @else
